...
while True:
    ...
    if qNo < qTotal:
        ...
        img, _ = cvzone.putTextRect (img, "Quiz completado", [250, 300], 2, 2, offset=50, border=5)
        img, _ = cvzone.putTextRect (img, f'Tu puntuacion es : {score}%', [700, 300], 2, 2, offset=50, border=5)
